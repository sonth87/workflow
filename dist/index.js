...
var _a$1;var NODES;(function(_0x4f3d58){_0x4f3d58['task']='task',_0x4f3d58['start']='start',_0x4f3d58['end']='end',_0x4f3d58['e-gateway']='exclusive-gateway';}(NODES||(NODES={})));var nodeTypes=(_a$1={},_a$1[NODES['task']]=Task,_a$1[NODES['start']]=StartEvent,_a$1[NODES['end']]=EndEvent,_a$1[NODES['e-gateway']]=ExclusiveGateway,_a$1);

var _a;var connectionStyle={'straight':'straight','step':'step','smoothstep':'smoothstep','bezier':'bezier'};var EDGES;(function(_0x66f48e){_0x66f48e['bezier']='bezier',_0x66f48e['connection']='connection',_0x66f48e['straight']='straight';}(EDGES||(EDGES={})));var connnectionTypes=(_a={},_a[EDGES['bezier']]=BezierEdgeConnectionLine,_a[EDGES['connection']]=CustomEdge,_a);
