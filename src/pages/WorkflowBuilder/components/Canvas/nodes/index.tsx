...
export const nodeTypes = {
  ...
  [NodeType.START_EVENT_WEB]: wrapWithBaseNode(StartEventNode, NodeType.START_EVENT_WEB),
  [NodeType.START_EVENT_API]: wrapWithBaseNode(StartEventNode, NodeType.START_EVENT_API),
  [NodeType.START_EVENT_TIMER]: wrapWithBaseNode(StartEventNode, NodeType.START_EVENT_TIMER),
  ...
  [NodeType.TASK_SEND_NOTIFICATION]: wrapWithBaseNode(TaskNode, NodeType.TASK_SEND_NOTIFICATION),
  ...
  [NodeType.TASK_BUSINESS_RULE]: wrapWithBaseNode(TaskNode, NodeType.TASK_BUSINESS_RULE),
