...
import type { InputComponent, MultilingualTextType } from '@/types/dynamic-bpm.type'
...
function formatDateTimeValue(
  ...
  if (!dayjsDate.isValid()) {
    return value as string | number | boolean | string[] | number[] | boolean[] | undefined
  }
      ...
      if (typeof value === 'string' && value.startsWith('$')) {
        ...
        if (responseData) {
          ...
          if (
            ...
            dynamicValue = formatDateTimeValue(dynamicValue, field_type, format)
          }
          ...
          if (
            ...
            if ('vi' in obj || 'en' in obj) {
              result[field_code] = getText(dynamicValue as unknown as MultilingualTextType)
            } else {
