...
export const baseNodeDefinitions: Record<BaseNodeType, BaseNodeDefinition> = {
  ...
  [BaseNodeType.IMMEDIATE]: {
    type: BaseNodeType.IMMEDIATE,
    category: CategoryType.IMMEDIATE,
    defaultProperties: {
      label: "Immediate",
      description: "Immediate action",
      immediateType: "notification",
    },
    visualConfig: baseVisualConfigs[BaseNodeType.IMMEDIATE],
    connectionRules: {
      maxInputConnections: -1,
      maxOutputConnections: -1,
    },
